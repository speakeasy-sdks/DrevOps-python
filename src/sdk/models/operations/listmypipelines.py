...
class ListMyPipelinesPipelineListResponsePipelineErrorsType(str, Enum):
    r"""The type of error."""
    CONFIG = 'config'
...
class ListMyPipelinesPipelineListResponsePipelineErrors:
    ...
    type: ListMyPipelinesPipelineListResponsePipelineErrorsType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of error."""
    
class ListMyPipelinesPipelineListResponsePipelineState(str, Enum):
...
class ListMyPipelinesPipelineListResponsePipelineTriggerType(str, Enum):
...
class ListMyPipelinesPipelineListResponsePipelineTrigger:
    ...
    type: ListMyPipelinesPipelineListResponsePipelineTriggerType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of trigger."""
...
class ListMyPipelinesPipelineListResponsePipeline:
    ...
    state: ListMyPipelinesPipelineListResponsePipelineState = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""The current state of the pipeline."""
