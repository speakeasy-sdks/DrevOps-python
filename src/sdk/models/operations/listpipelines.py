...
class ListPipelinesRequest:
    ...
    r"""Only include entries created by your user."""
    org_slug: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'org-slug', 'style': 'form', 'explode': True }})
    r"""Org slug in the form `vcs-slug/org-name`"""
...
class ListPipelinesPipelineListResponsePipelineErrorsTypeEnum(str, Enum):
    r"""The type of error."""
    CONFIG = 'config'
...
class ListPipelinesPipelineListResponsePipelineErrors:
    ...
    type: ListPipelinesPipelineListResponsePipelineErrorsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of error."""
    
class ListPipelinesPipelineListResponsePipelineStateEnum(str, Enum):
...
class ListPipelinesPipelineListResponsePipelineTriggerTypeEnum(str, Enum):
...
class ListPipelinesPipelineListResponsePipelineTrigger:
    ...
    actor: ListPipelinesPipelineListResponsePipelineTriggerActor = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('actor') }})
    r"""The user who triggered the Pipeline."""
    ...
    type: ListPipelinesPipelineListResponsePipelineTriggerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of trigger."""
...
class ListPipelinesPipelineListResponsePipelineVcs:
    ...
    commit: Optional[ListPipelinesPipelineListResponsePipelineVcsCommit] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('commit'), 'exclude': lambda f: f is None }})
    r"""The latest commit in the pipeline."""
...
class ListPipelinesPipelineListResponsePipeline:
    ...
    errors: list[ListPipelinesPipelineListResponsePipelineErrors] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors') }})
    ...
    state: ListPipelinesPipelineListResponsePipelineStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""The current state of the pipeline."""
    trigger: ListPipelinesPipelineListResponsePipelineTrigger = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('trigger') }})
    r"""A summary of the trigger."""
    ...
    vcs: Optional[ListPipelinesPipelineListResponsePipelineVcs] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vcs'), 'exclude': lambda f: f is None }})
    r"""VCS information for the pipeline."""
...
class ListPipelinesPipelineListResponse:
    ...
    items: list[ListPipelinesPipelineListResponsePipeline] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items') }})
...
class ListPipelinesResponse:
    ...
    list_pipelines_default_application_json_object: Optional[ListPipelinesDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error response."""
    pipeline_list_response: Optional[ListPipelinesPipelineListResponse] = dataclasses.field(default=None)
