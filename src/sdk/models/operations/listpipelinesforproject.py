...
class ListPipelinesForProjectPipelineListResponsePipelineErrorsTypeEnum(str, Enum):
    r"""The type of error."""
    CONFIG = 'config'
...
class ListPipelinesForProjectPipelineListResponsePipelineErrors:
    ...
    type: ListPipelinesForProjectPipelineListResponsePipelineErrorsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of error."""
    
class ListPipelinesForProjectPipelineListResponsePipelineStateEnum(str, Enum):
...
class ListPipelinesForProjectPipelineListResponsePipelineTriggerTypeEnum(str, Enum):
...
class ListPipelinesForProjectPipelineListResponsePipelineTrigger:
    ...
    actor: ListPipelinesForProjectPipelineListResponsePipelineTriggerActor = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('actor') }})
    r"""The user who triggered the Pipeline."""
    ...
    type: ListPipelinesForProjectPipelineListResponsePipelineTriggerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of trigger."""
...
class ListPipelinesForProjectPipelineListResponsePipelineVcs:
    ...
    commit: Optional[ListPipelinesForProjectPipelineListResponsePipelineVcsCommit] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('commit'), 'exclude': lambda f: f is None }})
    r"""The latest commit in the pipeline."""
...
class ListPipelinesForProjectPipelineListResponsePipeline:
    ...
    errors: list[ListPipelinesForProjectPipelineListResponsePipelineErrors] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors') }})
    ...
    state: ListPipelinesForProjectPipelineListResponsePipelineStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""The current state of the pipeline."""
    trigger: ListPipelinesForProjectPipelineListResponsePipelineTrigger = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('trigger') }})
    r"""A summary of the trigger."""
    ...
    vcs: Optional[ListPipelinesForProjectPipelineListResponsePipelineVcs] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vcs'), 'exclude': lambda f: f is None }})
    r"""VCS information for the pipeline."""
...
class ListPipelinesForProjectPipelineListResponse:
    ...
    items: list[ListPipelinesForProjectPipelineListResponsePipeline] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items') }})
...
class ListPipelinesForProjectResponse:
    ...
    list_pipelines_for_project_default_application_json_object: Optional[ListPipelinesForProjectDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error response."""
    pipeline_list_response: Optional[ListPipelinesForProjectPipelineListResponse] = dataclasses.field(default=None)
